...
INSTALLED_APPS = [
    'daphne',  # Channels needs daphne to be at the top
...
# Channel Layer for real-time messages
CHANNEL_LAYERS = {
    'default': {
...
# RabbitMQ Settings (for inter-service events)
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'rootpulse_core.exceptions.standard_exception_handler',
}
